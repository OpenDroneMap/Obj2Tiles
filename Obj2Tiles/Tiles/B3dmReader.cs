...
namespace Obj2Tiles.Tiles
{
    ...
    {
        public static Obj2Tiles.Tiles.B3dm ReadB3dm(BinaryReader reader)
        {
            ...
            var b3dm = new Obj2Tiles.Tiles.B3dm {
        ...
        public static Obj2Tiles.Tiles.B3dm ReadB3dm(Stream stream)
        {
